...
# Internal helpers shared by WBB and WNBA season-awards wrappers.
...
#' @param ... Unused.
#' @return A `wehoop_data` tibble with one row per award, or `NULL` on error.
#' @noRd
...
#' @param ... Unused.
#' @return A `wehoop_data` tibble with one row per winner, or `NULL` on error.
#' @noRd
