...
wbb_espn_game_all <- function(game_id, verbose = FALSE){
...
#' @examples
#'
#'  wbb_espn_pbp(game_id = 401287022)
#'
wbb_espn_pbp <- function(game_id, verbose = FALSE){
  options(stringsAsFactors = FALSE)
  options(scipen = 999)
...
#'
wbb_espn_team_box <- function(game_id, verbose = FALSE){
  options(stringsAsFactors = FALSE)
  options(scipen = 999)
  play_base_url <- "http://cdn.espn.com/womens-college-basketball/playbyplay?render=false&userab=1&xhr=1&"
...
#'
wbb_espn_player_box <- function(game_id, verbose = FALSE){
  options(stringsAsFactors = FALSE)
  options(scipen = 999)
  play_base_url <- "http://cdn.espn.com/womens-college-basketball/playbyplay?render=false&userab=1&xhr=1&"
...
wbb_espn_conferences <- function(){
  options(stringsAsFactors = FALSE)
  options(scipen = 999)
  play_base_url <- "http://site.api.espn.com/apis/site/v2/sports/basketball/womens-college-basketball/groups"
...
wbb_espn_scoreboard <- function(season, verbose = FALSE){
