# espn_basketball_position_helpers.R
# Internal helpers shared by the position dictionary wrappers.
# Each helper accepts the package's allowed league slugs.
# None of these are exported.

# ---------------------------------------------------------------------------
# .espn_basketball_positions
# ---------------------------------------------------------------------------

#' Internal: ESPN basketball positions index
#'
#' Fetches the position dictionary at
#' `sports.core.api.espn.com/v2/sports/basketball/leagues/{league}/positions`
...
#' @noRd
.espn_basketball_positions <- function(league, ...) {
...
# ---------------------------------------------------------------------------
# .espn_basketball_position
# ---------------------------------------------------------------------------

#' Internal: ESPN basketball position detail
#'
#' Fetches one position from
#' `sports.core.api.espn.com/v2/sports/basketball/leagues/{league}/positions/{position_id}`.
#'
#' @param league character.
...
#' @noRd
.espn_basketball_position <- function(league, position_id, ...) {
  .espn_bball_validate_league(league)
