...
#' [espn_wbb_pbp()] output by exposing the canonical core-v2 play record.
#'
#' @param event_id ESPN event identifier.
...
#' @examples
#' \donttest{
#'   espn_wbb_event_play(event_id = 401283399, play_id = 4012833997)
#' }
...
#' @examples
#' \donttest{
#'   espn_wbb_event_official_detail(event_id = 401283399, order = 1)
#' }
