...
# Internal helpers shared by WBB and WNBA team-detail wrappers.
...
.espn_bball_validate_league <- function(league) {
...
#'
#' Fetches `site.api.espn.com/apis/site/v2/sports/basketball/{league}/teams/{team_id}`
...
#'
#' Fetches `site.api.espn.com/apis/site/v2/sports/basketball/{league}/teams/{team_id}/roster`
...
#' @param ... Unused; absorbed for forward compatibility.
#' @return A single-row `wehoop_data` tibble, or `NULL` on error.
#' @keywords internal
