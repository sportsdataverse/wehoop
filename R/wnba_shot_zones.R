# ---------------------------------------------------------------------------
# WNBA shot-zone classification
#
# R port of sportsdataverse-py sportsdataverse/nba/nba_shot_zones.py::add_shot_zones.
# Classifies every field-goal attempt in a wehoop V3 PBP frame into one of five
# WNBA shot zones, mirroring the pbpstats-core convention used by sdv-py.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# wnba_shot_zones — public API
# ---------------------------------------------------------------------------

#' **Fetch WNBA Play-by-Play and Classify Field-Goal Attempts by Shot Zone**
#' @name wnba_shot_zones
NULL
#' @title
#' **Fetch WNBA Play-by-Play and Classify Field-Goal Attempts by Shot Zone**
#' @rdname wnba_shot_zones
#' @author Saiem Gilani
#' @param game_id A length-1 character string — the ten-character WNBA Stats
#'   game identifier (e.g. \code{"1022400003"} for a 2024 WNBA game).
...
#'
#'   All other columns from the V3 PBP schema (\code{wnba_pbp()}) are also
