...
#' `espn_wbb_news()` (league = "womens-college-basketball") and
#' `espn_wnba_news()` (league = "wnba").
#'
...
#' @return A `wehoop_data` tibble of articles, or `NULL` on error.
#' @keywords internal
...
#' by `espn_wbb_team_news()` and `espn_wnba_team_news()`.
#'
#' @param league character. One of `"wnba"` or `"womens-college-basketball"`.
