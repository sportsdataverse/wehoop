# espn_basketball_franchise_helpers.R
# Internal helpers shared by WBB and WNBA franchise wrappers.
...
#' @param ... Unused.
#' @return A `wehoop_data` tibble with one row per franchise, or `NULL` on error.
#' @noRd
