# espn_basketball_futures_helpers.R
# Internal helpers shared by WBB and WNBA futures wrappers.
# ESPN currently exposes per-season futures only for WNBA (not WBB), but
# the helper accepts the standard league validation for forward compatibility.

# ---------------------------------------------------------------------------
# .espn_basketball_futures
# ---------------------------------------------------------------------------
...
#' @param ... Unused.
#' @return A `wehoop_data` tibble in long format, or `NULL` on error.
#' @keywords internal
