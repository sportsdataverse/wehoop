...
x <- wnba_espn_scoreboard(season="20200829")

cols <- c("matchup", "matchup_short", "season", "type", "slug", "game_id", 
          "game_uid", "game_date", "attendance", "home_team_name", "home_team_logo", 
          "home_team_abb", "home_team_id", "home_team_location", "home_team_full", 
...
test_that("WNBA ESPN Scoreboard", {
