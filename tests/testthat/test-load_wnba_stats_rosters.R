test_that("load_wnba_stats_rosters returns a wehoop_data tibble for the most recent season", {
  skip_on_cran()
  skip_on_ci()
  skip_load_test()

  rosters <- load_wnba_stats_rosters(seasons = most_recent_wnba_stats_season())
