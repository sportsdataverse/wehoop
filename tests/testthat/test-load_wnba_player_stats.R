test_that("load_wnba_player_stats returns a wehoop_data tibble for the most recent season", {
  skip_on_cran()
  skip_on_ci()
  skip_load_test()

  player_stats <- load_wnba_player_stats(seasons = most_recent_wnba_season())
