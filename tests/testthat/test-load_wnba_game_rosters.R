test_that("load_wnba_game_rosters returns a wehoop_data tibble for the most recent season", {
  skip_on_cran()
  skip_on_ci()
  skip_load_test()

  game_rosters <- load_wnba_game_rosters(seasons = most_recent_wnba_season())
