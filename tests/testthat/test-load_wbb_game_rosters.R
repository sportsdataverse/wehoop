test_that("load_wbb_game_rosters returns a wehoop_data tibble for the most recent season", {
  skip_on_cran()
  skip_on_ci()
  skip_load_test()

  game_rosters <- load_wbb_game_rosters(seasons = most_recent_wbb_season())
