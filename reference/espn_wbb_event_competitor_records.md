...
``` r
espn_wbb_event_competitor_records(event_id, team_id, ...)
```
...
#> ✖ 2026-05-19 17:29:51.09199: Failed to retrieve ESPN womens-college-basketball competitor records for event_id=401812680, team_id=235
