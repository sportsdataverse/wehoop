...
for one WNBA season, in long format: one row per (team x stat).
...
#> ℹ Data updated: 2026-05-30 17:44:42 UTC
#> # A tibble: 0 × 12
...
#> #   value <dbl>, display_value <chr>, last_updated <chr>, team_ref <chr>
# }
```
