...
to enumerate the crew.

## Usage

``` r
espn_wbb_event_official_detail(event_id, official_id, ...)
```
...
``` r
# \donttest{
  espn_wbb_event_official_detail(event_id = 401283399, official_id = 6856)
#> Error in espn_wbb_event_official_detail(event_id = 401283399, official_id = 6856): argument "order" is missing, with no default
# }
```
