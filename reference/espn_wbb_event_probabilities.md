...
``` r
espn_wbb_event_probabilities(event_id, limit = 200, ...)
```
...
#> ✖ 2026-05-12 08:22:26.389935: Failed to retrieve ESPN womens-college-basketball event probabilities for event_id=401735229
