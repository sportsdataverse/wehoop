...
``` r
espn_wbb_athlete_splits(athlete_id, season = most_recent_wbb_season(), ...)
```
...
#> ✖ 2026-05-06 00:19:36.537436: Failed to retrieve ESPN womens-college-basketball athlete splits for athlete_id=4432755, season=2025
