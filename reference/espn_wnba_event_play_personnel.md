...
Returns the players on court at a specific WNBA play in long format (one
...
``` r
espn_wnba_event_play_personnel(event_id, play_id, ...)
```
...
#> ℹ Data updated: 2026-05-29 23:26:03 UTC
#> # A tibble: 0 × 7
