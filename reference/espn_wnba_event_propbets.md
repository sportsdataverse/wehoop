...
``` r
espn_wnba_event_propbets(event_id, provider_id, ...)
```
...
- provider_id:
  ...
  Sportsbook provider id (e.g. 58 = ESPN BET, 100 = Caesars). Look up
  via
...
#> ✖ 2026-05-22 07:12:07.203773: Failed to retrieve ESPN wnba event prop bets for event_id=401736171, provider_id=58
