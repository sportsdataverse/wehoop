...
#> ℹ Data updated: 2026-06-13 02:22:52 UTC
#> # A tibble: 1 × 12
...
#>   <chr>          <chr> <chr>   <list>       
#> 1 Overall Record total 9-3     <df [20 × 2]>
#> 2 Home Record    home  2-2     <df [5 × 2]> 
#> 3 Away Record    road  7-1     <df [5 × 2]> 
#> 
#> $NextEvent
...
#>   <chr>     <chr>             <chr>                            <chr>     
#> 1 401856987 2026-06-14T00:00Z Minnesota Lynx at Las Vegas Aces MIN @ LV  
#> 
#> $StandingSummary
