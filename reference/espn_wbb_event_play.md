...
``` r
espn_wbb_event_play(event_id, play_id, ...)
```
...
#> ✖ 2026-05-19 17:29:53.02293: Failed to retrieve ESPN womens-college-basketball event play detail for event_id=401283399, play_id=4012833997
