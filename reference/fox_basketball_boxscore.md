...
#> ℹ Data updated: 2026-09-10 00:48:49 UTC
#> # A tibble: 382 × 10
...
#> ℹ Data updated: 2026-09-10 00:48:51 UTC
#> # A tibble: 312 × 10
#>    game_id period     left_team right_team play_id clock team  left_score_change
#>    <chr>   <chr>      <chr>     <chr>      <chr>   <chr> <chr> <chr>            
...
#> ℹ Data updated: 2026-09-10 00:48:52 UTC
#> # A tibble: 0 × 0
# }
# \donttest{
  try(fox_wbb_odds("388986"))
#> ── Fox Sports WCBK odds ──────────────────────────────────────── wehoop 3.0.0 ──
#> ℹ Data updated: 2026-09-10 00:48:53 UTC
#> # A tibble: 0 × 0
# }
```
