...
#> ℹ Data updated: 2026-09-09 22:11:28 UTC
#> # A tibble: 382 × 10
...
#> ℹ Data updated: 2026-09-09 22:11:29 UTC
#> # A tibble: 378 × 7
#>    game_id team  stat_group player      athlete_id stat  value
#>    <chr>   <chr> <chr>      <chr>       <chr>      <chr> <chr>
...
#> ℹ Data updated: 2026-09-09 22:11:30 UTC
#> # A tibble: 0 × 0
# }
# \donttest{
  try(fox_wbb_odds("388986"))
#> ── Fox Sports WCBK odds ──────────────────────────────────────── wehoop 3.0.0 ──
#> ℹ Data updated: 2026-09-09 22:11:31 UTC
#> # A tibble: 0 × 0
# }
```
