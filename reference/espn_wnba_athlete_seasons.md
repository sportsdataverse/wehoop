...
``` r
espn_wnba_athlete_seasons(athlete_id, ...)
```
...
#> ✖ 2026-05-18 22:29:03.725189: Failed to retrieve ESPN wnba athlete seasons for athlete_id=1966
#> ✖ Args: league = "wnba", athlete_id = 1966
